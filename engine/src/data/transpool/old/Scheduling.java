...
public class Scheduling {
    ...
    public boolean isCurrentlyDeparting() {
        return TimeEngineBase.currentTime.getTime().equals(departureTime.get().getTime())
                && isHappeningOnDay(TimeEngineBase.currentTime.getDay());
    }
    ...
    public boolean isCurrentlyHappening() {
        return !TimeEngineBase.currentTime.getTime().isBefore(departureTime.get().getTime())
                && !TimeEngineBase.currentTime.getTime().isAfter(arrivalTime.get().getTime())
                && isHappeningOnDay(TimeEngineBase.currentTime.getDay());
    }
    ...
    public boolean isCurrentlyArriving() {
        return TimeEngineBase.currentTime.getTime().equals(arrivalTime.get().getTime())
                && isHappeningOnDay(TimeEngineBase.currentTime.getDay());
    }
