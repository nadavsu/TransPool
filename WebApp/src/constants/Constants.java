...
public class Constants {
    ...
    public static final String AMOUNT_TO_ADD = "amount";
    ...
    public static final String DEPARTURE_DAY = "departure-day";
    public static final String PPK = "ppk";
    public static final String PASSENGER_CAPACITY = "capacity";
